...
var vue_esm = __webpack_require__(5);
...
var test_service_TestService = /** @class */function () {
    ...
    TestService.prototype.hasTestAsserts = function (doc, testName) {
        if (!doc) {
            return undefined;
        }
        return documentation_service.getThis(this.testResults.tests, doc + ".results." + testName + ".results");
    };
                ...
                var setResult = function () {
                    if (val instanceof Promise) {
                        val.then(function (res) {
                            test.results.push({ pass: true, message: res.toString(), key: key });
                            runAssert(index + 1);
                        }).catch(function (res) {
                            test.results.push({ pass: false, message: res.toString(), key: key });
                            runAssert(index + 1);
                        });
                    } else {
                        test.results.push({ pass: val, message: val.toString(), key: key });
                        runAssert(index + 1);
                    }
                };
                if (!pre) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (!_this.testResults.tests[groupKey]) {
                vue_esm["default"].set(_this.testResults.tests, groupKey, {
                    total: _this.tests[groupKey] ? _this.tests[groupKey].length : 0,
                    pass: 0,
                    results: {}
                });
            }
            var setResults = function (res) {
                ...
                if (res.pass) {
                    _this.testResults.tests[groupKey].pass = _this.testResults.tests[groupKey].pass + 1;
                    return resolve(res);
                }
                return reject(res);
            };
            ...
            if (test.asserts && test.asserts.length) {
                _this.runAsserts(test).then(function (res) {
                    setResults({
                        pass: true,
                        message: "",
...
var src_test_section = __webpack_require__(143);
...
var doc_tests_decorate = undefined && undefined.__decorate || function (decorators, target, key, desc) {
    var c = arguments.length,
        r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc,
        d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var doc_tests_metadata = undefined && undefined.__metadata || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
var doc_tests_DocTests = /** @class */function (_super) {
    doc_tests_extends(DocTests, _super);
    function DocTests() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = 'doc-tests';
        _this.service = documentation_service;
        _this.testService = test_service;
        _this.testGroup = _this.testGroup;
        return _this;
    }
    Object.defineProperty(DocTests.prototype, "tests", {
        get: function () {
            var tests = this.service.getThis(this.testService.tests, this.testGroup + ".tests", {});
    ...
    Object.defineProperty(DocTests.prototype, "groupName", {
        get: function () {
            var name = this.service.docName(this.service.doc);
    ...
    doc_tests_decorate([Prop(), doc_tests_metadata("design:type", String)], DocTests.prototype, "testGroup", void 0);
    DocTests = doc_tests_decorate([vue_class_component_common_default()({
        template: doc_tests,
        components: {
            'test-item': src_test_item_0
        },
...
/* harmony default export */ var src_doc_tests = (doc_tests_DocTests);
...
var src_json_viewer = __webpack_require__(139);
...
var json_viewer_TableRenderer = /** @class */function (_super) {
    json_viewer_extends(TableRenderer, _super);
    ...
    TableRenderer.prototype.jsonViewer = function (json) {
    ...
    Object.defineProperty(TableRenderer.prototype, "newJson", {
        get: function () {
    ...
    TableRenderer.prototype.mounted = function () {
        this.jsonViewer(this.json);
    };
    json_viewer_decorate([Prop(), json_viewer_metadata("design:type", Object)], TableRenderer.prototype, "json", void 0);
    TableRenderer = json_viewer_decorate([vue_class_component_common_default()({
...
/* harmony default export */ var src_json_viewer_0 = (json_viewer_TableRenderer);
// EXTERNAL MODULE: ../src/table-renderer.scss
var src_table_renderer = __webpack_require__(137);
...
var documentation_Documentation = /** @class */function (_super) {
    ...
    Documentation.prototype.launch = function (doc) {
        ...
        if (container) {
            container.innerHTML = "";
            if (this.components) {
                var _Class = this.components[doc.meta.name.default];
                if (_Class) {
...
module.exports = {"components":{"Demo":{"name":"Demo","kind":"Class","children":{"DocksData":{"name":"DocksData","kind":"Property","default":" DocsData","type":"any"},"name":{"name":"name","kind":"Property","default":"App","type":"string"},"tests":{"name":"tests","kind":"Object literal","children":{"Demo":{"name":"Demo","kind":"Variable","default":" demoTests","type":"Tests"}},"default":"","type":"object"}}}},"services":{"TestCase":{"name":"TestCase","kind":"Class","children":{"asserts":{"name":"asserts","kind":"Property","default":" [\n        {\n            name: should add ${this.val1} plus ${this.val2} to equal 3,\n            fn: () => this.methods.add() === 3\n        },\n        should subtract 2 from 1 to equal 1,\n        should fail\n    ]","type":"any"},"name":{"name":"name","kind":"Property","default":" sample test case","type":"string"},"val1":{"name":"val1","kind":"Property","default":"1","type":"number"},"val2":{"name":"val2","kind":"Property","default":"2","type":"number"},"methods":{"name":"methods","kind":"Object literal","children":{"add":{"name":"add","kind":"Function","default":"","type":"Function"},"should fail":{"name":"should fail","kind":"Function","default":"","type":"Function"},"should subtract 2 from 1 to equal 1":{"name":"should subtract 2 from 1 to equal 1","kind":"Function","default":"","type":"Function"}},"default":"","type":"object"}}},"TestCase2":{"name":"TestCase2","kind":"Class","children":{"asserts":{"name":"asserts","kind":"Property","default":" [\n        {\n            name: 1 equals ${this.val},\n            fn: () => {\n                return 1 === this.val\n            }\n        }\n    ]","type":"any"},"name":{"name":"name","kind":"Property","default":" Tests 2","type":"string"},"val":{"name":"val","kind":"Property","default":"1","type":"number"}}},"Tests":{"name":"Tests","kind":"Class","children":{"name":{"name":"name","kind":"Property","default":"Demo","type":"string"},"tests":{"name":"tests","kind":"Property","default":" [\n        new TestCase(),\n        new TestCase2()\n    ]","type":""}}}}};
